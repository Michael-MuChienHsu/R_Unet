...
video_dir_list = get_video_dir_list(video_path)[0:16]
...
batch_size = len(video_dir_list) ## batch size = number of video
...
for epochs in range(start_epoch, start_epoch + epoch_num):
    ...
    for batch in range(0, batch_size):
        ...
        new_frame_paths = [ frame_paths[i] for i in range(0, len(frame_paths), 3) ]
